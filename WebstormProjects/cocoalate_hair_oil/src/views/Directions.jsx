    ...
    return(
        <div className="directions-main-frame">
            ...
            <p>
                ...
                In the morning, wash your hair thoroughly with a gentle shampoo to remove any excess oil.
                Follow up with conditioner as usual to keep your hair soft and manageable.
                Frequency:

                For best results, use the hair growth oil 2-3 times per week as part of your regular hair care routine.
                Consistency is key, so continue using the oil regularly to see visible improvements in hair growth and health over time.
                Caution:

                Avoid contact with eyes. If contact occurs, rinse thoroughly with water.
                Perform a patch test before using the oil to check for any allergic reactions or skin sensitivities.
                Discontinue use if irritation occurs and consult a healthcare professional if necessary.
                Storage:

                Store the hair growth oil in a cool, dry place away from direct sunlight.
                Keep the bottle tightly closed when not in use to prevent oxidation and maintain the quality of the oil.
                Disclaimer:

                This hair growth oil is intended for external use only. Avoid ingestion and keep out of reach of children.
            </p>
        </div>
    )
}